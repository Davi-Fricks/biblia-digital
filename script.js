...
function fetchChapter() {
    ...
    const devocionais = [
        /* janeiro, favereiro, marco, abril, maio, junho, julho, agosto, setembro, outubro, novembro, dezembro */
        {
    ...
    if (devocional_busca != undefined) {
        ...
        //         })
        //         .catch(error => {
        //             console.error('Erro:', error);        //             alert('Erro ao buscar o capítulo. Verifique os dados e tente novamente.');
        //         });
        // }
    }
